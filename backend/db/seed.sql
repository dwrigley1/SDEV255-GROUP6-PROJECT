...
INSERT INTO courses (id, name, description, subject, credits, creator_id) VALUES
  (1, 'ENGL 111 - English Composition', 
  ...
  (3, 'MATH 221 - Calculus for Technology I',
  ...
  (4, 'MATH 222 - Calculus for Technology II',
